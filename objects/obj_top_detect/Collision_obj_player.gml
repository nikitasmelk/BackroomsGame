//MOVE ALL WALLS
obj_bot_detect.y -= 1024;
y -= 1024;
obj_right_detect.y -= 1024;
obj_left_detect.y -= 1024;

// DELETE OLD CHUNKS
y_temp = 2*room_height/3 + 774;

instance_create_layer(obj_distance_tracker.x, y_temp, "Detection", obj_destroy);
...
// GENERATE NEW CHUNKS
tracker_lengthy = -(room_height/3 - obj_distance_tracker.y);
...
//RESET TRACKER
obj_distance_tracker.y = tracker_lengthy;